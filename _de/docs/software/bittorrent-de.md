...
??? Hinweis "Ein Download-Client ist erforderlich"
...
=== "Optional: Ändern Sie, welche BitTorrent-Sites Medusa durchsuchen soll"
    ...
    - Klicken Sie auf die `Einstellungen` „Zahnrad“-Schaltfläche (in der oberen rechten Ecke des Bildschirms).
...
=== "Schnellstart"
    ...
    ![Bazarr-Untertitel Fundliste](../assets/images/dietpi-software-download-bazarr.jpg){: width="1105" height="490" loading="lazy"}
