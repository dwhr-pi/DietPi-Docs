...
- [**phpBB - Kostenlose Flat-Forum-Bulletin-Board-Softwarelösung**](#phpbb)
- [**Wordpress - Website-Blog und Veröffentlichungsplattform**](#wordpress)
...
DietPi erstellt automatisch die SQL-Datenbank für phpBB. Bitte befolgen Sie die nachstehenden Schritte, um diese Details in phpBB einzugeben und die Einrichtung abzuschließen.
...
Mit Ihren zuvor erstellten Admin-Login-Daten können Sie nun Ihre Forenseiten verwalten und erstellen.
...
Damit können Sie Ihre eigene Website erstellen.
...
*Single File PHP Gallery* ermöglicht es Ihnen, Ihre Bilder von einer Weboberfläche aus zu hosten und zu durchsuchen.
...
=== "OpenBazaar-Client"
    ...
    Der Client ermöglicht es Ihnen, innerhalb des Marktnetzwerks von OpenBazaar zu stöbern und zu handeln.
...
=== "OpenBazaar-Client mit Ihrem OpenBazaar-Server verbinden"
    ...
    Schritt 2:
    Als nächstes müssen Sie den OpenBazaar-Client öffnen und Ihren Server hinzufügen:
...
=== "Kunde"
    ...
    Für die Kommunikation mit Synapse können Sie [Element](https://element.io/) verwenden, aber jeder Client, der das Matrix-Protokoll unterstützt, sollte funktionieren.

=== "Föderation"

    Synapse ist standardmäßig als privater Server ohne Verbindung zu anderen Servern eingerichtet. ??? Information "rmationen zum Verbinden mit anderen Servern (Federate) finden Sie unter https://github.com/matrix-org/synapse/blob/develop/docs/federate.md. Beachten Sie, dass frp derzeit nicht mit Synapse funktioniert.
...
=== "Serviceabwicklung"
    ...
    Die DietPi-Synapse-Implementierung erstellt einen systemd-Dienst „synapse.service“, um den Synapse-Server zu starten und zu steuern. Folgende Befehle können verwendet werden:
...
=== "Protokolle anzeigen"
    ...
    Protokolle werden im Systemjournal erstellt und können angezeigt werden über:
...
=== "Auf neueste Version aktualisieren"
    ...
    Da Synapse über Python 3 Pip installiert wird, können Sie es aktualisieren über:
