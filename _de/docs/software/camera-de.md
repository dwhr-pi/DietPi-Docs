...
=== "Zugriff auf Aufzeichnungen (ohne Webinterface)"
    ...
    Um ohne das Webinterface aus der Ferne auf Ihre Aufzeichnungen zuzugreifen, möchten Sie vielleicht einen der [Dateiserver von DietPi](../file_servers/) installiert haben.
...
=== "Zugriff auf die Weboberfläche"
    ...
    Passwörter können im Webinterface konfiguriert werden.
...
Streamen Sie JPEG-Frames von verschiedenen Quellen zu verschiedenen möglichen Ausgängen. Mit der Standardeinstellung wird ein angehängtes Kamerabild mit dem enthaltenen HTTP-Plugin auf eine einfache Webseite gestreamt.
...
=== "HTML-Authentifizierung"
    ...
    5. Oberhalb dieser Zeile müssen Sie ein weiteres `ExecStart=` ohne Inhalt hinzufügen, das den ursprünglichen Startbefehl entfernen soll, damit Ihr ihn effektiv ersetzt. Die Datei könnte schließlich so aussehen:
