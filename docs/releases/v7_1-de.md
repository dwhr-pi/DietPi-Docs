...
- **DietPi-FS_partition_resize** :octicons-arrow-right-16: Unterstützung hinzugefügt, um die Größe von F2FS- und Btrfs-Dateisystemen beim ersten Start automatisch zu ändern.
