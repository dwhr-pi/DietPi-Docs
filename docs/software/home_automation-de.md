...
=== "Erstinstallation und Zugriff"
    ...
    Wenn Sie Verarbeitungsdetails sehen möchten, führen Sie „htop“ auf einem dedizierten Terminal oder einer SSH-Sitzung aus, um den Python-Build-Prozess live zu sehen.
...
=== "Python-Umgebung anpassen"
    ...
    Dadurch wird eine eigenständige Python-Instanz platziert, die völlig unabhängig von anderen installierten Python-Instanzen oder -Modulen ausgeführt wird. Wenn Sie zusätzliche Python-Module in dieser pyenv-Umgebung installieren, Python selbst aktualisieren oder ähnliches müssen, müssen Sie eine Shell als Benutzer „homeassistant“ öffnen und die pyenv-Umgebung aktivieren:
...
Domoticz ist ein Hausautomationssystem, mit dem Sie verschiedene Geräte wie Lampen, Schalter, verschiedene Sensoren/Messgeräte für Temperatur, Regen, Wind, UV-Strahlung, elektrische Felder, Gas, Wasser und vieles mehr überwachen und konfigurieren können. Benachrichtigungen/Warnungen können an jedes mobile Gerät gesendet werden.
