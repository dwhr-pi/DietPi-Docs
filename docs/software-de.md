...
- [**qBittorrent - Leichter und schneller (C++) BitTorrent-Server mit Webinterface**](bittorrent-de/#qbittorrent)
- [**rTorrent - BitTorrent-Server mit ruTorrent-Weboberfläche**](bittorrent-de/#rtorrent)
- [**Aria2 - Downloadmanager mit Webinterface**](bittorrent-de/#aria2)
- [**SABnzbd - NZB-Download-Manager mit Weboberfläche**](bittorrent-de/#sabnzbd)
- [**Medusa - Fernsehsendungen automatisch herunterladen**](bittorrent-de/#medusa)
- [**Sonarr - Fernsehsendungen automatisch herunterladen**](bittorrent-de/#sonarr)
- [**Radarr - Filme automatisch herunterladen**](bittorrent-de/#radarr)
- [**Bazarr - Untertitel für Sonarr/Radarr automatisch herunterladen**](bittorrent-de/#bazarr)
- [**Lidarr - Musik automatisch herunterladen**](bittorrent-de/#lidarr)
- [**Jackett - API-Unterstützung für Ihre bevorzugten Torrent-Tracker**](bittorrent-de/#jackett)
- [**NZBGet - NZB-Download-Manager mit Weboberfläche**](bittorrent-de/#nzbget)
...
- [**Nextcloud Talk - Videoanrufe über Nextcloud, einschließlich TURN-Server**](cloud-de/#nextcloud-talk)
- [**Pydio - Funktionsreicher Backup- und Sync-Server mit Weboberfläche**](cloud-de/#pydio)
- [**UrBackup Server - Vollständige Sicherungen für Systeme in Ihrem Netzwerk**](cloud-de/#urbackup)
- [**Gogs - Server im GitHub-Stil, mit Weboberfläche**](cloud-de/#gogs)
- [**Gitea - Server im GitHub-Stil, mit Weboberfläche**](cloud-de/#gitea)
- [**Syncthing - Backup- und Sync-Server mit Webinterface**](cloud-de/#syncthing)
- [**MinIO - S3-kompatibler verteilter Objektserver**](cloud-de/#minio)
- [**Firefox Sync Server - Lesezeichen, Tabs, Verlauf und Passwörter synchronisieren**](cloud-de/#firefox-sync-server)
- [**vaultwarden - Inoffizieller Bitwarden-Passwort-Manager-Server, geschrieben in Rust**](cloud-de/#vaultwarden)
...
- [**SQLite - Kleine, schnelle und hochzuverlässige SQL-Datenbank-Engine**](databases-de/#sqlite)
...
- [**MATE - Beliebter Gnome 2-Desktop**](desktop-de/#mate)
...
- [**PiJuice - PiSupply USV/Batteriestromsystem**](hardware_projects-de/#pijuice)
- [**RPi.GPIO - GPIO-Schnittstellenbibliothek für RPi (Python)**](hardware_projects-de/#rpigpio)
...
- [**myMPD - Leichtgewichtiger Webinterface-Audioplayer für MPD**](media-de/#mympd)
- [**O!MPD - Funktionsreicher Audio-Player mit Web-Schnittstelle für MPD**](media-de/#ompd)
- [**CAVA - Optional: Konsolenbasierter Audiovisualisierer für MPD**](media-de/#cava)
- [**Mopidy - Webinterface Musik/Radioplayer**](media-de/#mopidy)
- [**Airsonic-Advanced - Feature-Rich-Media-Streaming-Server mit Weboberfläche**](media-de/#airsonic)
- [**Logitech Media Server - auch bekannt als LMS, Squeezebox Server**](media-de/#logitech-media-server)
- [**Squeezelite - Audioplayer für Logitech Media Server**](media-de/#squeezelite)
- [**Shairport Sync - AirPlay-Audioplayer mit Multiroom-Synchronisierung**](media-de/#shairport-sync)
- [**ReadyMedia - (MiniDLNA) Media-Streaming-Server (DLNA, UPnP)**](media-de/#readymedia)
- [**Ampache - Medien-Streaming-Server der Webschnittstelle**](media-de/#ampache)
- [**Emby - Media-Streaming-Server der Webschnittstelle**](media-de/#emby)
- [**Plex Media Server - Medien-Streaming-Server der Webschnittstelle**](media-de/#plex-media-server)
- [**Tautulli - Überwachungs- und Tracking-Tool für Plex Media Server**](media-de/#tautulli)
- [**Murmeln - Mumble VoIP-Server**](media-de/#murmeln)
- [**Roon Bridge - Verwandelt Ihr Gerät in einen Roon-fähigen Audioplayer**](media-de/#roon-bridge)
- [**Roon Server - Verwandelt Ihr Gerät in einen Roon-fähigen Audioplayer und Roon-Kern**](media-de/#roon-server)
- [**Roon Extension Manager - Verwalten Sie Erweiterungen innerhalb von Roon**](media-de/#roon-extension-manager)
- [**NAA Daemon - Signalyst Network Audio Adapter (NAA)**](media-de/#naa-daemon)
- [**IceCast - Shoutcast Streaming Server, einschließlich DarkIce**](media-de/#icecast)
- [**Koel - Webschnittstellen-Streaming-Server**](media-de/#koel)
- [**GMediaRender - Ressourceneffizienter UPnP/DLNA-Renderer**](media-de/#gmediarender)
- [**Ubooquity - Kostenloser Heimserver für Ihre Comic- und E-Book-Bibliothek**](media-de/#ubooquity)
- [**Komga - Kostenloser und quelloffener Medienserver für Comics/Mangas mit Web-Benutzeroberfläche**](media-de/#komga)
- [**Raspotify - Spotify Connect-Client**](media-de/#raspotify)
- [**Spotify Connect Web - Webinterface, Client und Player für Spotify Premium**](media-de/#spotify-connect-web)
- [**Spotifyd - Lightweight FOSS Spotify-Client**](media-de/#spotifyd)
- [**Jellyfin - Media-Streaming-Server mit Live-TV**](media-de/#jellyfin)
- [**Beets - Musikorganisator und -manager**](media-de/#beets)
...
- [**Wordpress - Website-Blog und Veröffentlichungsplattform**](social-de/#wordpress)
- [**Einzeldatei-PHP-Galerie - Hosten und durchsuchen Sie Ihre Bilder über eine Weboberfläche**](social-de/#single-file-php-gallery)
- [**Baïkal - Lightweight CalDAV + CardDAV-Server**](sozial-de/#baikal)
...
- [**Linux Dash - Systemstatistiken der Webschnittstelle**](system_stats-de/#linux-dash)
- [**phpSysInfo - Systemstatistik der Webschnittstelle**](system_stats-de/#phpsysinfo)
- [**RPi-Monitor - Systemstatistiken der Webschnittstelle**](system_stats-de/#rpi-monitor)
- [**Netdata - Systemstatistiken der Webschnittstelle**](system_stats-de/#netdata)
...
- [**LAMP-Webstack - Apache / MariaDB / PHP**](webserver_stack-de/#lamp-web-stack)
- [**LASP-Webstack - Apache / SQLite / PHP**](webserver_stack-de/#lasp-web-stack)
- [**LEMP-Webstack - Nginx / MariaDB / PHP**](webserver_stack-de/#lemp-web-stack)
- [**LESP-Webstack - Nginx / SQLite / PHP**](webserver_stack-de/#lesp-web-stack)
